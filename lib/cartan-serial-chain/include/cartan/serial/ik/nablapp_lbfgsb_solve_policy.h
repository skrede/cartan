#ifndef HPP_GUARD_LIEPP_SERIAL_IK_NABLAPP_LBFGSB_SOLVE_POLICY_H
#define HPP_GUARD_LIEPP_SERIAL_IK_NABLAPP_LBFGSB_SOLVE_POLICY_H
...
///
/// This is the nablapp-backed L-BFGS-B. The native liepp implementation
...
private:
    using nablapp_solver = nablapp::basic_solver<nablapp::lbfgsb_policy<joints>, joints>;
