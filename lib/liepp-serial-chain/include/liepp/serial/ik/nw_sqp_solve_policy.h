#ifndef HPP_GUARD_LIEPP_SERIAL_IK_NW_SQP_SOLVE_POLICY_H
#define HPP_GUARD_LIEPP_SERIAL_IK_NW_SQP_SOLVE_POLICY_H
...
public:
    ...
    nw_sqp_solve_policy() = default;

    explicit nw_sqp_solve_policy(const options& opts)
        : m_options{opts}
    {}
...
private:
    using nablapp_solver = nablapp::basic_solver<nablapp::nw_sqp_policy<>>;
