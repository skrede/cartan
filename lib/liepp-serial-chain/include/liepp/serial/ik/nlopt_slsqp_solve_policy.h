...
{
public:
    static_assert(std::is_floating_point_v<Scalar>, "nlopt_slsqp_solve_policy requires a floating-point Scalar type");
...
private:
        ...
        void* data)
    {
        ...
        auto result = ik_se3_objective<Scalar, N>::evaluate(
            *self->m_chain, self->m_target, q);
