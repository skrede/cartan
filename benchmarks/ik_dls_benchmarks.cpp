...
static void bm_ik_dls_3r_planar(benchmark::State& state)
{
    ...
    for (auto _ : state)
    {
        ...
        liepp::basic_ik_solver<liepp::dls_solve_policy<liepp::kinematic_chain<double, 3>>> solver;
...
static void bm_ik_dls_ur3e(benchmark::State& state)
{
    ...
    for (auto _ : state)
    {
        ...
        liepp::basic_ik_solver<liepp::dls_solve_policy<liepp::kinematic_chain<double, 6>>> solver;
        solver.setup(chain, target, q_seed, criteria);
        auto result = solver.solve();
...
static void bm_ik_dls_lbr_med14(benchmark::State& state)
{
    ...
    for (auto _ : state)
    {
        ...
        liepp::basic_ik_solver<liepp::dls_solve_policy<liepp::kinematic_chain<double, 7>>> solver;
        solver.setup(chain, target, q_seed, criteria);
        auto result = solver.solve();
