...
// ============================================================================
// LM converges on reachable 6R target
// ============================================================================

TEST_CASE("LM converges on reachable 6R target", "[ik][lm]")
{
    ...
    spp::lm_solve_policy<spp::kinematic_chain<double, 6>> stepper;
...
// ============================================================================
// LM converges on 3R planar target
// ============================================================================

TEST_CASE("LM converges on 3R planar target", "[ik][lm]")
{
    ...
    spp::lm_solve_policy<spp::kinematic_chain<double, 3>> stepper;
...
// ============================================================================
// LM returns iteration_limit on unreachable target
// ============================================================================

TEST_CASE("LM returns iteration_limit on unreachable target", "[ik][lm]")
{
    auto chain = make_ur5_like_chain();
...
// ============================================================================
// LM lambda adapts during iteration
// ============================================================================

TEST_CASE("LM lambda adapts during iteration", "[ik][lm]")
{
    auto chain = make_ur5_like_chain();
    ...
    // (either increased or decreased depending on step quality)
    REQUIRE(stepper.lambda() != Approx(lambda_initial).margin(1e-15));
}
...
TEST_CASE("LM iterations count", "[ik][lm]")
{
    auto chain = make_ur5_like_chain();
