...
TEST_CASE("restart_solve_policy concept satisfaction", "[ik][restart]")
{
    static_assert(spp::ik_solve_policy<
        spp::restart_solve_policy<double, 6, spp::projected_lm_solve_policy<double, 6>>>);
}
...
TEST_CASE("restart_solve_policy trivial convergence", "[ik][restart]")
{
    ...
    spp::restart_solve_policy<double, 6, spp::projected_lm_solve_policy<double, 6>> stepper;
...
TEST_CASE("restart_solve_policy re-seeds after stall", "[ik][restart]")
{
    ...
    spp::projected_lm_solve_policy<double, 6>::options inner_opts;
    inner_opts.stall_window = 3;
    inner_opts.stall_threshold = 1e-4;

    spp::restart_solve_policy<double, 6, spp::projected_lm_solve_policy<double, 6>>::options opts;
    opts.max_restarts = 20;

    spp::restart_solve_policy<double, 6, spp::projected_lm_solve_policy<double, 6>> stepper(
        opts, spp::projected_lm_solve_policy<double, 6>(inner_opts));
...
TEST_CASE("restart_solve_policy warm-start lambda", "[ik][restart]")
{
    ...
    spp::restart_solve_policy<double, 6, spp::projected_lm_solve_policy<double, 6>> stepper(opts);
...
TEST_CASE("restart_solve_policy composes with racing_scheduler", "[ik][restart]")
{
    ...
    using restart_type = spp::restart_solve_policy<double, 6, spp::projected_lm_solve_policy<double, 6>>;
