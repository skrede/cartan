...
{
    static_assert(spp::ik_solve_policy<spp::newton_raphson_solve_policy<spp::kinematic_chain<double, 6>>>);
}
...
TEST_CASE("newton_raphson_solve_policy converges on UR5", "[ik][newton_raphson]")
{
    ...
    spp::newton_raphson_solve_policy<spp::kinematic_chain<double, 6>> stepper;
...
TEST_CASE("newton_raphson_solve_policy composes with restart_solve_policy", "[ik][newton_raphson]")
{
    ...
    using inner_type = spp::newton_raphson_solve_policy<spp::kinematic_chain<double, 6>>;
    using restart_type = spp::restart_solve_policy<spp::kinematic_chain<double, 6>, inner_type>;
...
TEST_CASE("newton_raphson_solve_policy handles singular configuration", "[ik][newton_raphson]")
{
    ...
    spp::newton_raphson_solve_policy<spp::kinematic_chain<double, 6>>::options opts;
    opts.divergence_factor = 2.0;
    opts.stall_window = 5;
    opts.stall_threshold = 1e-6;
    spp::newton_raphson_solve_policy<spp::kinematic_chain<double, 6>> stepper(opts);
