...
// joint count the instance actually holds, down to one.
...
/// The narrowest joint count below the smallest fixture the decomposition
/// answers at.
...
TEMPLATE_TEST_CASE("damped least squares answers at one joint",
    "[dls][dynamic][svd]", double, float)
{
...
TEMPLATE_TEST_CASE("null-space enforcement answers at one joint",
    "[limits][dynamic][svd]", double, float)
{
