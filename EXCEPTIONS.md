...
| lib/cartan-serial-chain/include/cartan/serial/ik/basic_ik_runner.h | 726 | the runner and its variadic multi-policy overloads are one class template; the policy pack is threaded through every member, so a split would repeat the pack expansion in each half |
