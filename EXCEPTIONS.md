...
| lib/cartan-analytical/include/cartan/analytical/solver_6r.h | 761 | one closed-form derivation carried from the geometric decomposition through branch enumeration to the assembled solution set; each step is licensed by the geometric assumption the step above established, and a split would separate a step from its justification |
