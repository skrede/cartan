...
| tests/boundary/solver_setup_boundary_test.cpp | 484 | a case list over one subject whose fixtures, helpers and tolerance constants are declared once above the cases and used by all of them; splitting it duplicates that setup into each fragment, where the copies drift and two files then test against different fixtures |
