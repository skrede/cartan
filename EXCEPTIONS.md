...
| lib/cartan-serial-chain/include/cartan/serial/ik/solver/lm.h | 326 | one solver class whose state, step and termination bookkeeping are read together; splitting it puts the invariant tying a step to its convergence test in one header and the state it reads in another |
