...
| lib/cartan-urdf/include/cartan/urdf/parser.h | 566 | one traversal over the document: the element handlers share the error accumulation and the name table they resolve against, and a split would hand both to every handler through an interface built for one caller |
